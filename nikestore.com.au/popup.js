document.addEventListener('DOMContentLoaded', function() {
    update_state = function() {
        ...
        status_item_div = document.getElementById('status-item');
        ...
        chrome.storage.local.get([
            ...
            status_item_div.textContent = 'Desired item: "' + items.desired_item + '"';
    ...
    state_btn.addEventListener('click', function() {
        ...
        chrome.storage.local.set({
            ...
            'desired_item': document.getElementById('desired-item').value.replace(/^\s+|\s+$/g, ''),
            'desired_size': document.getElementById('desired-size').value.replace(/^\s+|\s+$/g, ''),
        });
        update_state();
    });
    chrome.storage.local.get(['desired_item', 'desired_size'], function(items) {
        document.getElementById('desired-item').value = items.desired_item;
